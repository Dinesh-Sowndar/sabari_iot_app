...
// import 'package:IoT_App/widgets/loading_widget.dart';
...
//  static Future<Map> changeSwitchStatus(String key,Map<String, dynamic> data) async {
//     await _db.collection('switch').document(key).setData(data).catchError((err) {
//       server_error();
//       if (Get.isDialogOpen) {
//         Get.back();
//       }
